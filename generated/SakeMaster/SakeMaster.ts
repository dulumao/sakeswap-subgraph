...
export class SakeMaster__poolInfoResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class SakeMaster__userInfoResult {
  value0: BigInt;
  value1: BigInt;
...
export class SakeMaster extends ethereum.SmartContract {
  static bind(address: Address): SakeMaster {
    return new SakeMaster("SakeMaster", address);
  }

  BETATEST_BLOCKNUM(): BigInt {
    let result = super.call(
      "BETATEST_BLOCKNUM",
      "BETATEST_BLOCKNUM():(uint256)",
      []
    );
  ...
  try_BETATEST_BLOCKNUM(): ethereum.CallResult<BigInt> {
  ...
  BONUSONE_MULTIPLIER(): BigInt {
    let result = super.call(
      "BONUSONE_MULTIPLIER",
      "BONUSONE_MULTIPLIER():(uint256)",
      []
    );
  ...
  try_BONUSONE_MULTIPLIER(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "BONUSONE_MULTIPLIER",
      "BONUSONE_MULTIPLIER():(uint256)",
      []
  ...
  BONUSTWO_MULTIPLIER(): BigInt {
    let result = super.call(
      "BONUSTWO_MULTIPLIER",
      "BONUSTWO_MULTIPLIER():(uint256)",
      []
    );
  ...
  try_BONUSTWO_MULTIPLIER(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "BONUSTWO_MULTIPLIER",
      "BONUSTWO_MULTIPLIER():(uint256)",
      []
  ...
  BONUS_BLOCKNUM(): BigInt {
    let result = super.call("BONUS_BLOCKNUM", "BONUS_BLOCKNUM():(uint256)", []);

    return result[0].toBigInt();
  }

  try_BONUS_BLOCKNUM(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "BONUS_BLOCKNUM",
      "BONUS_BLOCKNUM():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  MINTEND_BLOCKNUM(): BigInt {
    let result = super.call(
      "MINTEND_BLOCKNUM",
      "MINTEND_BLOCKNUM():(uint256)",
      []
    );
  ...
  try_MINTEND_BLOCKNUM(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "MINTEND_BLOCKNUM",
      "MINTEND_BLOCKNUM():(uint256)",
      []
  ...
  betaTestEndBlock(): BigInt {
    let result = super.call(
      "betaTestEndBlock",
      "betaTestEndBlock():(uint256)",
      []
    );
  ...
  try_betaTestEndBlock(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "betaTestEndBlock",
      "betaTestEndBlock():(uint256)",
      []
  ...
  lpTokenPID(param0: Address): BigInt {
    let result = super.call("lpTokenPID", "lpTokenPID(address):(uint256)", [
  ...
  try_lpTokenPID(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall("lpTokenPID", "lpTokenPID(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  mintEndBlock(): BigInt {
    let result = super.call("mintEndBlock", "mintEndBlock():(uint256)", []);

    return result[0].toBigInt();
  }

  try_mintEndBlock(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("mintEndBlock", "mintEndBlock():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  poolInfo(param0: BigInt): SakeMaster__poolInfoResult {
    let result = super.call(
      "poolInfo",
    ...
    return new SakeMaster__poolInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_poolInfo(
    param0: BigInt
  ): ethereum.CallResult<SakeMaster__poolInfoResult> {
    let result = super.tryCall(
      "poolInfo",
      "poolInfo(uint256):(address,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new SakeMaster__poolInfoResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  sake(): Address {
    let result = super.call("sake", "sake():(address)", []);

    return result[0].toAddress();
  }

  try_sake(): ethereum.CallResult<Address> {
    let result = super.tryCall("sake", "sake():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  sakePerBlock(): BigInt {
    let result = super.call("sakePerBlock", "sakePerBlock():(uint256)", []);

    return result[0].toBigInt();
  }

  try_sakePerBlock(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("sakePerBlock", "sakePerBlock():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  userInfo(param0: BigInt, param1: Address): SakeMaster__userInfoResult {
    let result = super.call(
      "userInfo",
    ...
    return new SakeMaster__userInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_userInfo(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<SakeMaster__userInfoResult> {
    let result = super.tryCall(
      "userInfo",
      "userInfo(uint256,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SakeMaster__userInfoResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  pendingSake(_pid: BigInt, _user: Address): BigInt {
    let result = super.call(
      "pendingSake",
      "pendingSake(uint256,address):(uint256)",
      [
  ...
  try_pendingSake(_pid: BigInt, _user: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "pendingSake",
      "pendingSake(uint256,address):(uint256)",
      [
...
export class HandoverSakeMintageCall extends ethereum.Call {
  get inputs(): HandoverSakeMintageCall__Inputs {
    return new HandoverSakeMintageCall__Inputs(this);
  }

  get outputs(): HandoverSakeMintageCall__Outputs {
    return new HandoverSakeMintageCall__Outputs(this);
  }
}

export class HandoverSakeMintageCall__Inputs {
  _call: HandoverSakeMintageCall;

  constructor(call: HandoverSakeMintageCall) {
    this._call = call;
  }
...
export class HandoverSakeMintageCall__Outputs {
  _call: HandoverSakeMintageCall;
